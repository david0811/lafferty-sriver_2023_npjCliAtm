...
azcopy copy 'https://mpctransfer.blob.core.windows.net/mpctransfer/cil-gdpcir/hotdry/' "${OUT_PATH}/cil-gdpcir/" --recursive
azcopy copy 'https://mpctransfer.blob.core.windows.net/mpctransfer/cil-gdpcir/hot_spatial/' "${OUT_PATH}/cil-gdpcir/" --recursive
